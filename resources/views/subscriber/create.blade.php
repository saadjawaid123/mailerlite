...
@section('content')
    ...
    <div class="page-header">
        <h1 class="page-title">Add Subscriber</h1>
        <div>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" id="addSubscriber" novalidate>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-3 mb-3">
                                <label for="validationCustom05">Subscribe Date</label>
                                <div class="input-group">
                                    <div class="input-group-text">
                                        <i class="fa fa-calendar tx-16 lh-0 op-6"></i>
                                    </div><input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" id="validationCustom05" type="text">
                                </div>
                                <div class="invalid-feedback">Please select a valid Subscribe Date.</div>
                            </div>
                            <div class="col-xl-3 mb-3">
                                <label for="tp3">Subscribe Time</label>
                                <div class="input-group">
                                    <div class="input-group-text">
                                ...
                                <div class="invalid-feedback">Please select a valid Subscribe Time.</div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered text-center " role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body text-center p-4 pb-5">
                    ...
                    <h4 class="text-success tx-semibold">Saved!</h4>
